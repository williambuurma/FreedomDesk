...
> **Purpose:** Canonical reading order for Cursor agents and anyone building on FreedomDesk. Read these documents in sequence before modifying product behavior, knowledge, reasoning, or call handling.

When documents conflict, defer to the authority chain established in each document — starting with the Constitution.
...
### 2. [KNOWLEDGE_ENGINE.md](KNOWLEDGE_ENGINE.md)
...
### 3. [FREEDOMDESK_OFFICE_DNA.md](FREEDOMDESK_OFFICE_DNA.md)

The canonical definition of practice-specific operating profiles (Layer 3 knowledge). Governs what belongs in an office profile — scheduling, insurance, clinical workflows, staff preferences, and front-desk rules — and how office-specific configuration differs from universal and regional defaults.

### 4. [FREEDOMDESK_BRAIN_ARCHITECTURE.md](FREEDOMDESK_BRAIN_ARCHITECTURE.md)
